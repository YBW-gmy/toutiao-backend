...
class User(Base):
    ...
    bio: Mapped[Optional[str]] = mapped_column(String(255), comment="个人简介",default="这个人很懒，什么都没有留下")
    phone: Mapped[Optional[str]] = mapped_column(String(20), comment="手机号",default=None,unique=True)
